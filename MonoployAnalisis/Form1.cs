...
namespace MonoployAnalisis
{
    public partial class Form1 : Form
    {
        ...
        private void rollDice_Click(object sender, EventArgs e)
        {
            ...
            Tuple<int, int> values = RollDiceValueTuple();
            int diceImage1 = values.Item1;

            int diceImage2 = values.Item2;

            RollingDice(diceImage1, diceImage2);

            int diceMove = diceImage1 + diceImage2;
            System.Diagnostics.Debug.WriteLine("Dice move:" + diceMove);
        }
